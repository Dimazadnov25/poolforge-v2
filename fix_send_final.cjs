...
// Send Button nach HAWK Link einfügen
const sendBtn = `
...
// SendWidget Komponente vor return einfügen
const sendWidget = `
  function SendWidget({ wallet, onRefresh }) {
...
c = c.replace('  return (\n    <div', sendWidget + '  return (\n    <div')

fs.writeFileSync(file, c)
console.log('✅ SendWidget eingefügt')