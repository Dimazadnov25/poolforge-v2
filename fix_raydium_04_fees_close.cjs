...
// --- collectFees ---
const collectFees = `import { Connection, PublicKey, Transaction, TransactionInstruction } from '@solana/web3.js'
...
// --- closePosition ---
const closePosition = `import { Connection, PublicKey, Transaction, TransactionInstruction } from '@solana/web3.js'
...
fs.writeFileSync('api/raydium-collect-fees.js', collectFees)
fs.writeFileSync('api/raydium-close-position.js', closePosition)
console.log('✅ raydium-collect-fees.js + raydium-close-position.js erstellt')