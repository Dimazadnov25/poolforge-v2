  ...
  return(
    <div style={{display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",
      ...
      <div style={{display:"flex",alignItems:"center",gap:"0.6rem"}}>
        <span style={{fontSize:"2rem",fontWeight:700,color:"#818cf8",fontFamily:"Rajdhani,sans-serif"}}>{maxSol.toFixed(4)}</span>
        <button onClick={doSwap} disabled={loading||!publicKey||maxSol<=0} style={{
          ...
          fontSize:"1rem",cursor:"pointer",padding:"0.4rem 1.2rem",fontFamily:"Share Tech Mono,monospace"
