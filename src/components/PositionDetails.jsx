...
export default function PositionDetails({ position, poolState, fetchPosition, onClose, onCollect, onAddLiquidity, onRebalance, onUpdate }) {
  ...
  const currentPrice = poolState?.solPrice || poolState?.currentPrice || 0;
  ...
  return (
    <div className="position-card">
      <div className="position-header">
        ...
        <span className={adge }>{isInRange ? 'IN RANGE' : 'OUT OF RANGE'}</span>
      </div>
      <div className="position-grid">
        <span className="label">Min Price</span><span className="value"></span>
        <span className="label">Max Price</span><span className="value"></span>
        <span className="label">Current Price</span><span className="value" style={{color:'var(--green)'}}></span>
        <span className="label">Position Value</span><span className="value" style={{color:'var(--green)'}}> USD</span>
        ...
        <span className="label">Earned (live)</span><span className="value" style={{color:'var(--green)'}}> USD</span>
